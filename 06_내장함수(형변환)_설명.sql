...
SELECT 123000 + 10, TO_CHAR(123000) + 10, 
        '123000' + 10, TO_NUMBER('123000') + 10 FROM DUAL;
...
SELECT TO_CHAR(1230.5, 'L999,999,999'), TO_CHAR(1230.5,'L000,000,000') FROM DUAL; -- 반올림처리됨.
...
SELECT TO_CHAR(1230.5544, 'L999,999.99'), TO_CHAR(1230.5544,'L000,000.00') FROM DUAL;


-- TO_DATE(문자열, 형식문자) : 문자 -> 날짜타입
SELECT '2021-04-16', SYSDATE FROM DUAL;
SELECT '2021-04-16', TO_DATE('2021-04-16','YYYY-MM-DD') FROM DUAL;
SELECT '2021-04-16' + 1 FROM DUAL; --'2021-04-16'이 문자열이므로 오류 발생:ORA-01722: invalid number
SELECT '2021-04-16' || 1 FROM DUAL; -- '2021-04-161'이 되어버림

SELECT TO_DATE('2021-04-16', 'YYYY-MM-DD')+1  FROM DUAL;
SELECT '2021-04-16 17:57:16', TO_DATE('2021-04-16 17:57:16', 'YYYY-MM-DD HH24:MI:SS')
FROM DUAL;
...
-- 1초 후
SELECT TO_CHAR(SYSDATE,'YYYY-MM-DD HH24:MI:SS') FROM DUAL; -- 현재시간과 비교해보기
